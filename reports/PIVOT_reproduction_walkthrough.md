...
* **Giải pháp:** Kết hợp song song hai giải pháp:
  ...
  - **Giảm Batch Size xuống 4 (`--batchsize 4`):** Giảm dung lượng VRAM tức thời của các batch chứa các thực thể trung tâm lớn (hubs), giữ lượng VRAM hoạt động luôn dưới mốc an toàn.
