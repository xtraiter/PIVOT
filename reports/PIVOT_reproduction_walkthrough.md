...
* **Giải pháp:** Cấu hình giảm batch size huấn luyện xuống còn 8 (`--batchsize 8`). Việc này giúp giảm tuyến tính dung lượng VRAM tiêu thụ đi 2 lần, giữ cho GPU hoạt động an toàn và ổn định mà vẫn đảm bảo quá trình huấn luyện hội tụ chính xác.
